...
QUERY=$(echo '' | rofi -theme Hanzo6 -kb-row-select "Tab" -kb-row-tab "Control+space" -hide-scrollbar -color-window "#000000, #000000, #000000" -color-normal "#000000, #1793D1, #000000, #1793D1, #000000" -color-active "#000000, #1793D1, #000000, #1793D1, #000000" -color-urgent "#000000, #1793D1, #000000, #1793D1, #000000" -dmenu -mesg ">>> Tab = Autocomplete" -i -p "websearch: ")
