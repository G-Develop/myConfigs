...
const CenterAreaHorizontalSpacingPrefsWidget = new GObject.Class({
    Name: 'CenterAreaHorizontalSpacing.Prefs.Widget',
    GTypeName: 'CenterAreaHorizontalSpacingPrefsWidget',
    Extends: Gtk.Grid,
    ...
    _init: function(params) {
        ...
        let hscale = Gtk.Scale.new_with_range(Gtk.Orientation.HORIZONTAL, 0, 18, 1);
...
function buildPrefsWidget() {
    let widget = new CenterAreaHorizontalSpacingPrefsWidget();
    widget.show_all();
